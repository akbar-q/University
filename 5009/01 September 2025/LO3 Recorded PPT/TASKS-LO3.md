...
## Task 1 — AND Gate: Safe-to-Run Permissive

![AND gate safe-to-run permissive diagram](Images/01%20AND%20Gate%20%E2%80%93%20%E2%80%9CSafe%20to%20Run%E2%80%9D.png)
...
## Task 2 — OR Gate: Buzzer on Fault OR Completion

![OR gate buzzer on fault or completion diagram](Images/02%20OR%20Gate%20%E2%80%93%20Alarm.png)
...
## Task 3 — XOR Gate: Two-Sensor Disagreement (Mismatch)

![XOR gate two-sensor mismatch diagram](Images/03%20XOR%20Gate%20%E2%80%93%20Mismatch%20Two-Sensor%20Disagreement%20Detection.png)
...
## Task 4 — Blinky 1: Cycle-On Lamp (Heartbeat)

![Blinky cycle running lamp (heartbeat) diagram](Images/04%20Blinky%201%20%E2%80%94%20Cycle%20Running%20Lamp%20(Heartbeat%20%20Status).png)
...
## Task 5 — Blinky 2: Fault Lamp + Buzzer Beep Pattern

![Blinky fault lamp + buzzer beep pattern diagram](Images/05%20Blinky%202%20Fault%20Lamp%20Buzzer%20Beep%20Pattern.png)
...
## Task 6 — Counting 1: Pill Counter to Target (CTU)

![Counting pill counter to target (CTU) diagram](Images/06%20Counting%201%20Pill%20Counter%20to%20Target%20(CTU).jpeg)
...
## Task 7 — Counting 2: Reject/Fault Event Counter

![Counting reject/fault event counter diagram](Images/07%20Counting%202%20Reject%20Fault%20Event%20Counter.jpg)
...
## Task 8 — Variables: Simple AirCon Control (Start/Stop + Threshold)

![AirCon control variables task diagram](Images/08%20Variables%20Task%20%E2%80%94%20AirCon%20Control.png)
...
![ADC acquisition and scaling diagram](Images/09%20ADC%20Acquisition%20Maths%20Raw%20Voltage%20-%20Temperature.jpg)
...
## Process / Tank Control Tasks — Constraints (Industrial Process Context)
...
## Task 10 — Oil Separation Tank (Level Control)

![Oil separation tank diagram](Images/10%20Oil%20Seperation%20Tank.png)
...
## Task 11 — Water Filling and Discharging Control (Sterilisation Feed Tank)

![Simple tank fill/drain diagram](Images/11%20Simple%20Tank%20Fill%20Drain%20with%20Start%20Stop%20Panel%20(MV1%2C%20MV2%2C%20TLB).png)
...
## Task 12 — Wet Granulation Mixing (With Temperature Control)

![Agitated mixing tank diagram](Images/12%20Agitated%20Mixing%20Tank%20(2%20materials%20%2B%20heater%20%2B%20levels).png)
...
## Task 13 — Parallel Tanks Level + Temperature Control (Sterilisation Support)

![Two-tank heat/cool transfer system diagram](Images/13%20Two-Tank%20Heat%20Cool%20Transfer%20System%20(V1%E2%80%93V5%2C%20LHLL%2C%20TT).png)
...
2) Run Task 1 (AND gate permissive) to prove safety interlock
3) Run Task 6 (counting to target CTU) to trigger actuator
4) Trigger fault → show Task 2 (OR gate buzzer) + Task 5 (fault lamp pattern)
5) Show Task 3 XOR mismatch behaviour (toggle sensors)
6) Show Task 9 ADC raw-to-temperature scaling + high-temp alarm
7) Show Task 8 Variables/AirCon control (Start/Stop latch + threshold compare)
8) (Optional) Show one process task (Task 11 or Task 12) if time allows
